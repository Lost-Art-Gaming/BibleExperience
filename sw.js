const CACHE = 'bible-experience-production-v24';
const ASSETS = [
  './', './index.html', './styles.css?v=24', './production.css?v=24', './artwork.js?v=24', './app.js?v=24', './manifest.webmanifest', './assets/logo.svg',
